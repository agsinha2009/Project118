...
function draw(){
    setInterval(check_sketch, 1);

    if(sketch_drawn==Sketch){
        answer_holder="set";
        score=score+1;
        document.getElementById("Score").ineerHtml="Score: "+score;
    }
}
